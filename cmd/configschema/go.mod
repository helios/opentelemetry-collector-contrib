...
require (
	...
	github.com/helios/opentelemetry-collector-contrib/exporter/kafkaexporter v0.66.0 // indirect
	...
	go.opentelemetry.io/collector/extension/zpagesextension v0.66.0 // indirect
